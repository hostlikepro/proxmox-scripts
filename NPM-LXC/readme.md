...
```bash
curl -sL https://raw.githubusercontent.com/hostlikepro/proxmox-scripts/npm-lxc/create.sh | bash -s
```
...
```bash
curl -sL https://raw.githubusercontent.com/hostlikepro/proxmox-scripts/npm-lxc/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://raw.githubusercontent.com/hostlikepro/proxmox-scripts/npm-lxc/setup.sh | sh
```
